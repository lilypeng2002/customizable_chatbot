...
with col2:
    ...
    if send_pressed:
        ...
        save_conversation(user_id, content, save_conversation_content)
        st.session_state['last_submission'] = ''
