...
if st.button('Send', key='sendButton'):
    ...
    if user_message:  # Ensure there is a message to send
        ...
        # Append the bot response to the conversation history and display
        st.session_state.chat.append({'role': 'bot', 'content': bot_response})
